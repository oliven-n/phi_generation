...
def compare_embeddings_query(query_text):
    ...
    formatted_results = "--- Matching Results ---\n"
    for doc, score in results:
        formatted_results += f"Score: {score}\n"
        formatted_results += f"Content: {doc.page_content}\n"
        formatted_results += f"Source: {doc.metadata.get('source', 'N/A')}\n"
        formatted_results += "---\n"
    formatted_results += "--- Query Ended ---\n"
...
if __name__ == "__main__":
    ...
    print(compare_embeddings_query(query_text))

# this is the version in the main branch
# 
# # import argparse
# from langchain_community.vectorstores import Chroma
# from langchain_openai import OpenAIEmbeddings
...
# this old version is correct but is difficult for the user to read.
